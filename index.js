...
const classes = 60; // total de aulas no semestre
...
const getDoc = async () => {
    ...
    await sheet.loadCells('A1:H27'); // buscando o tamanho das celulas

    // condico em cima dos estudantes
    try {
        ...
        for (let index = 3; index < 27; index++) {
            ...
            // condicoes para aprovacao/reprovacao
            if (average < 50) {
